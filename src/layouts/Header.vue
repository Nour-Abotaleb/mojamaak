...
<template>
  <header>
    ...
    >
      <div
        class="flex-col-reverse flex lg:flex-row flex-wrap justify-between items-center mx-auto"
      >
        <div
        ...
        >
          ...
          >
            ...
            <li>
              <router-link
                to="/"
                class="!top-0 flex items-center justify-center py-2 pr-4 pl-3"
              >
                <img
                  :src="logoSrc"
                  class="h-6 sm:h-9"
        ...
        <div class="relative inline-block text-left">
          ...
          <div class="relative me-2" ref="searchRef">
            <button
              @click="toggleSearch"
              class="flex gap-2 items-center text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-2 py-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800"
            >
              {{ t("nav.search") }}
              <svg
                class="w-5 h-5 text-gray-800 dark:text-white"
            ...
            <!-- Search Input -->
            <div v-if="showSearchInput" class="absolute top-14 z-10">
              <input
                v-model="searchQuery"
                type="text"
                :placeholder="t('nav.search')"
                class="w-[300px] border rounded-lg dark:bg-gray-800 dark:text-white dark:border-gray-600"
              />
            </div>
          </div>
          <button
