...
<template>
    <div class="bg-white dark:bg-gray-800" data-aos-duration="1700" data-aos="fade-left">
        <div class="container mx-auto p-4 max-w-screen-xl">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-9 font-shamel">
                <div v-for="(card, index) in cards" :key="index"
                    class="card bg-white dark:bg-gray-900 dark:border-gray-700 font-[500] border rounded-xl overflow-hidden">
                    <img :src="card.image" alt="Card Image" class="w-full h-48 object-cover rounded-xl" />
                    <div class="p-4">
                        <h3 class="text-lg font-bold mb-2 text-right  dark:text-white">{{ card.title }}</h3>
                        ...
                        <button class="mt-4 bg-transparent border border-[#d8dade] dark:border-gray-700 dark:text-gray-300
                     text-[#636770] font-bold hover:bg-gray-100 gap-3 dark:hover:bg-gray-700
                         py-3 px-4 rounded-lg
                                w-auto flex items-center justify-center mx-auto">
                            عرض التفاصيل <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none">
                                <path d="M3.5 22H20.5" stroke="#636770" stroke-width="1.5" stroke-miterlimit="10"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M5 3.5L19 17.5" stroke="#636770" stroke-width="1.5" stroke-miterlimit="10"
                                    stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M5 13.77V3.5H15.27" stroke="#636770" stroke-width="1.5" stroke-miterlimit="10"
                                    stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </button>
                    </div>
            ...
            <nav class="border-t pt-10 mt-10 w-full dark:border-t-gray-700" aria-label="Page navigation example">
                <ul class="justify-between w-full inline-flex -space-x-px text-sm">
                    ...
                    <li>
                        <a href="#"
                            class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Next
