...
<template>
    ...
    <section class="bg-white dark:bg-gray-800 font-shamel overflow-hidden" :dir="direction">
        <div class="py-8 mx-auto sm:py-20">
            <div class="gap-4 items-center py-8 mx-auto lg:grid lg:grid-cols-2 lg:py-16 justify-between">
                ...
                <div data-aos-duration="1700" data-aos="fade-right" class="mx-auto mt-[50px] lg:mt-0 ">
                    <img class="w-full " src="../../assets/about7.PNG" alt="unkown image">
                </div>
