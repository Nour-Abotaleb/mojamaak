        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-20 lg:px-6">
            ...
            ">
                ...
                <div data-aos-duration="1700" data-aos="fade-right" class="mx-auto mt-[50px] lg:mt-0 ">
                    <img class="w-full md:w-[80%] rounded-xl" src="../../assets/aboutFour.png" alt="unkown image">
                </div>

                <div data-aos-duration="1700" data-aos="fade-left"
                    class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                    <div
                        class="bg-[#f6eafe] rounded-full min-w-12 min-h-12 w-12 h-12 flex items-center justify-center mb-7">
