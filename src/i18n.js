...
const messages = {
  en: {
   ...
   howWeWork: {
    ...
    contact: {
      ...
      content: "Content",
      agree: "I agree to",
      privacyPolicy: "the terms and conditions",
      send: "Send Message",
      ...
      privacy: "We care about your data in our privacy policy",
      ourTeam: "Our friendly team is here to help",
      headOffice: "Head Office",
      welcomeHeadOffice: "Welcome to our head office",
      workingDays: "Monday to Friday, 8am to 5pm",
      contactUs: "Contact Us",
      contactForm: "Contact Form",
      weWantToHearFromYou: "We'd love to hear from you! Please fill out the form below",
      weLoveToHearFromYou: "We love to hear from you",
      haveQuestions: "Have any questions or facing any issues? Don’t hesitate to reach out to our support team. We’ll be happy to assist you as soon as possible."
    },
    complexes: {
  ...
  realEstate: {
    ...
    contact: {
      ...
      stayUpdated: "ابق على اطلاع بكل جديد لدينا",
      privacy: "نحن نهتم ببياناتك في سياسة الخصوصية الخاصة بنا",
      ourTeam: "فريقنا الودود هنا لمساعدتك",
      headOffice: "المكتب الرئيسي",
      welcomeHeadOffice: "مرحبًا بك في مقرنا الرئيسي",
      workingDays: "من الإثنين إلى الجمعة 8 صباحًا حتى 5 مساءً",
      contactUs: "تواصل معنا",
      contactForm: "نموذج التواصل",
      weWantToHearFromYou: "نود أن نسمع منك! يرجي ملء النموذج أدناه",
      weLoveToHearFromYou: "نحن نحب أن نسمع منك",
      haveQuestions: "هل لديك استفسارات أو تواجه أي مشكلات؟ لا تتردد في التواصل مع فريق الدعم. وسنكون سعداء بمساعدتك في أسرع وقت ممكن"
    },
    partnersSection: {
  ...
  ku: {
    nav: {
      home: "ماڵەوە",
      about: "دەربارەی سیستەمەکە",
      pricing: "نرخ و بەشداریکردنەکان",
      complexes: "کۆمپلێکسە نیشتەجێبووانەکان",
      partners: "هاوبەشەکان",
    ...
    slider: {
      welcome: "بەخێربێیت بۆ Mojamaak",
      welcomeDescription: "ئێمە بناوبانگەکانی ئەندازیاری و بیناسازی دەسازین بۆ ڕۆژانی باشتر",
      future: "لە ئێستادا لە ڕۆژانی داهاتوو بەهرەوەربە",
      futureDescription: "دیزاینی نوێ، لوکس، و بەردەوام بۆ ژیانی باشتر",
      creativity: "جیهانی خەیاڵ و بەرهەم",
      creativityDescription: "فکری تەبدیل دەکەین بۆ ڕاستی بە کیفیتی جیهانی و تیکنەلۆجیای پێشکەوتوو"
    },
    aboutMojamaak: {
      whatIsYourComplex: "Mojamaak چییە؟",
      complexDescription: "Mojamaak پلاتفۆرمێکی تەواوە بۆ بەڕێوەبردنی کۆمپلێکسە نیشتەجێبووانەکان. بە ئاسانیدا بەڕێوەبردنی خانووەکان، بەڕێوەبەرەکان، چاودێری چاکسازی و پارەدان دەکات.",
      personWorking: "کارمەند"
    },
    common: {
      learnMore: "زانیاری زیاتر"
    },
    features: {
      manageEasy: "بەڕێوەبردنی کۆمپلێکس و خانوو بە ئاسانیدا",
      manageProperties: "زیادکردن و دەستکاری کردنەوەی خانوو و کۆمپلێکس بە ئاسانیدا",
      trackUnits: "چاودێری دۆخی خانوو (بەتاڵ / پڕکراو)",
      paymentTracking: "چاودێری پارەدان و بەشداریکردنەکان",
      recordPayments: "تۆمارکردنی پارەدان و دانانی ڕۆژ بۆ داهاتوو",
      generateInvoices: "دروستکردنی ڕەسید و ڕاپۆرتی دارایی",
      smartMaintenance: "سیستەمی زانیاری چاکسازی",
      handleRequests: "وەرگرتنی داواکاری و چاودێری ئەنجامدانیان",
      assignToVendors: "پەیوەندیدانی داواکارییەکان بە کڕیارە چاکسازەکان و چاودێری پێشکەوتنیان",
      realTimeNotifications: "ئاگاداریە ڕاستەوخۆکان",
      sendAlerts: "ناردنی ئاگاداری بە ئەرکدار و نیشتەجێبوو",
      receiveUpdates: "وەرگرتنی نوێکاریەکان دەربارەی پارەدان، چاکسازی و پێشنیازە نوێکان",
      whyYourComplex: "بۆچی Mojamaak؟",
      mainFeatures: "تایبەتمەندیە سەرەکییەکان",
      systemAdvantages: "فایدەکانی سیستەمەکە",
      apartmentManagement: "بەڕێوەبردنی خانوو و بنایەکان",
      apartmentManagementDesc: "ڕێکخستنی خانوو و زیادکردنی نیشتەجێبووان",
      maintenanceTracking: "چاودێری داواکارییە چاکسازییەکان",
      maintenanceTrackingDesc: "وەرگرتنی داواکاری و ناردنیان بۆ تیمتە چاکسازییە تایبەتەکان",
      financialManagement: "بەڕێوەبردنی پارەدان",
      financialManagementDesc: "سیستەمێکی پارەدان و ڕەسیدەکانی ئەلیکترۆنی بە ئاسایش",
      instantNotifications: "ئاگادارییەکانی کاتی ڕاستەوخۆ",
      instantNotificationsDesc: "نوێکارییە ڕاستەوخۆکان لەسەر چاکسازی، کرێ، و پێشنیازەکان"
    },
    howWeWork: {
      title: "چۆن کاردەکەین؟",
      addCompounds: "زیادکردنی کۆمپلێکس و خانوو",
      addCompoundsDesc: "تۆمارکردنی کۆمپلێکس و گرێدان بە خانووە بەتاڵەکان",
      registerResidents: "تۆمارکردنی نیشتەجێبووان و بەڕێوەبردنی زانیارییان",
      registerResidentsDesc: "زیادکردنی زانیاری نیشتەجێبووان و جۆری نیشتەجێبوون",
      trackRequests: "چاودێری داواکارییە چاکسازییەکان و پارەدانەکان",
      trackRequestsDesc: "بە ئاسانیدا بەڕێوەبردنی پارەدان و چاودێری داواکارییەکان"
    },
    vision: {
      title: "ئامانجی ئێمە و بینینەکانمان",
      intro: "Mojamaak تایبەتمەندییەکی گەورەی پێشکەش دەکات بۆ سەرکردایەتی کۆمپلاکسە نیشتەجێبووانەکان بە ئاسانترین ڕێگا و بە کارامەیی زۆر، بۆ باشترکردنی ئەزموونی بەکارهێنەر و خەرجکردنی کەمترین کات و هەوڵ."
    },
    realEstate: {
      title: "ڕێکخستنی کارەساتی ئەملاک",
      centralPlatform: "پلاتفۆرمێکی ناوەندی پێشکەش دەکات بۆ بەڕێوەبردنی کۆمپلاکسەکان، خانووەکان و نیشتەجێبووان بە ئاسانترین ڕێگا.",
      searchFilter: "دەتوانیت بگەڕێی و فلتەر بەکارهێنی بۆ دۆزینەوەی وردەکاریەکانی یەکەکان بە خێرایی.",
      statusTracking: "یارمەتیدەدات بە ڕاگەیاندنی دۆخی یەکەم (بەردەست / لە بەکارهێنان / لە ژێر چاکسازی) بە ڕووناکی."
    },
    payments: {
      title: "چاودێری خواست و پارەدان بە ئاسانترین ڕێگا",
      accurateSystem: "سیستەمێکی ڕەسەن دابین دەکات بۆ تۆمارکردنی پارەدان و ڕیزبەندی بۆ داواکارییە داهاتووەکان.",
      detailedReports: "ڕاپۆرتی دارایی بە وردەکاری دروست دەکات بۆ پیشاندانی داهاتوو و قەرزەکان.",
      exportInvoices: "بەڕێوەبەر دەتوانێ فاکتەر و بەڵگەنامەی پارەدان بە تەنها کلیکێک دابەزێنێ."
    },
    maintenance: {
      title: "باشترکردنی چاکسازی و خزمه‌تگوزارییەکان",
      easyInterface: "ڕووکاری بەکارهێنانی ئاسان پێشکەش دەکات بۆ بەڕێوەبردنی داواکارییە چاکسازییەکان.",
      requestStatus: "ڕەچاو دەکات بۆ دۆخی داواکاری (نوێ / لە جێریان / تەواو بوو) لە داشبۆرد.",
      assignVendors: "ڕێگەدەدات بە بەڕێوەبەران داواکاریەکان بۆ کۆمپانیای چاکسازی فەرمی بڵاو بکەنەوە و چاودێری جێبەجێکارییەکانیان بکەن.",
      maintenanceTitle: "کۆمپانیای چاکسازی ڕەسمی",
      maintenanceDescription: "ئێمە پێشنیاری باشترین کۆمپانیای چاکسازی دەكەین بۆ پەیوەندیکردنی بە ئاسانترین شێوە لە ڕێگەی سیستەمەوە. بە شێوەیەکی گشتی، ئەگەر پێویستی بە کارەبا، پەلامبەر، ساردکەرەوە یان هەر خزمەتگوزارییەکی ترت هەبێت، دەتوانیت کۆمپانیاکان بگەڕێیت و پەیوەندیت پێوە بکەیت."
    },
    security: {
      title: "بەهێزکردنی سەلامەتی و کۆنتڕۆڵ",
      logging: "هەموو کردارەکان تۆمار دەکرێن بۆ چاودێری داهاتوو.",
      permissions: "ڕێگەپێدان بە ڕووکاری بەکارھێنەر بەپێی ڕۆڵی بەکارهێنەر.",
      encryption: "پاراستنی زانیاری بە تەکنەلۆژیا پارێزگاری پیشکەوتوو."
    },
    faq: {
      title: "پرسیارە باوەکان",
      intro: "وەڵامی زۆرینەی پرسیارەکان سەبارەت بە Mojamaak",
      q1: "چۆن دەتوانم خۆم تۆمار بکەم؟",
      a1: "دەتوانیت لەڕێگەی فۆڕمی ماڵپەڕ تۆماربکەیت.",
      q2: "ئایا پارە دەکرێ بۆ بەشداربوون؟",
      a2: "نەخێر، بەشداربوونەکە بە تەواوی بەخۆرایییە.",
      q3: "چۆن دەتوانم پەیوەندی پێوە بکەم؟",
      a3: "دەتوانیت پەیوەندی بکەیت لە ڕێگەی ئیمەیڵ یان تەلەفۆن کە لە پەڕەی پەیوەندیدا دەنراوە.",
      q4: "چۆن دەتوانم ریزەرڤ بکەم؟",
      a4: "دەتوانیت سەردانی ماڵپەڕ بکەیت و خزمەتگوزاری گونجاوت دیاری بکەیت."
    },
    cta: {
      title: "هێشتا پرسیارەکانت ماوە؟",
      subtitle: "بەشداری بکە لەگەڵ زیاتر لە 4000 کۆمەڵگەی نیشتەجێبووان کە Mojamaak بەکار دەهێنن!",
      button: "زانیاری زیاتر"
    },
    pricing: {
      pricing: "نرخی خزمەتگوزاری",
      pricingPlan: "پلاناتی نرخەکان لە Mوجەماک",
      planDescription: "پلانی گونجاو هەلبژێر بۆ بەڕێوەبردنی کۆمەڵگا. Mوجەماک پلانی ئاسایی و پێشکەوتوو بۆ کۆمپلەکسە جیاوازەکان پێشکەش دەکات.",
      choosePlan: "پلانی باشترین هەلبژێر بۆ بەڕێوەبردنی کۆمەڵگاکەت",
      choosePlanDesc: "کات و هەوڵت خەلاص بکە بە پلانی بەشداریکردن. بە شێوەیەکی کارا کۆمەڵگاکەت بەڕێوەببە",
      basic: "پلانی بنەڕەتی",
      basic1: "پلانی پێشەنگ",
      basic2: "پلانی پێشکەوتوو",
      monthly: "مانگانە",
      unlimited: "بەڕێوەبردنی کۆمەڵگا",
      unlimited1: "تۆمارکردنی هاوەڵاتیان",
      unlimited2: "چاودێری چاکسازی",
      unlimited3: "بەڕێوەبردنی پارەدان",
      unlimited4: "راپۆرتە داراییەکان",
      unlimited5: "پشتیوانی ٢٤/٧",
      start: "دەست پێبکە",
      popular1: "زۆرترین بەکارهاتوو",
    },
    contact: {
      fullName: "ناوی تەواو",
      content: "ناوەڕۆک",
      agree: "قبوڵ دەکەم بە",
      privacyPolicy: "مەرجەکان و شەرەوطەکان",
      send: "ناردنی نامە",
      enterName: "ناوت لێرە بنوسە",
      writeMessage: "نامەکەت لێرە بنوسە...",
      enterEmail: "ئیمەیڵ بنوسە",
      subscribeNow: "ئێستا بەشداربە",
      joinCommunity: "بەشداربە لە کۆمەڵگایەکەمان",
      stayUpdated: "نوێترین هەواڵەکانمان بەدەستهێنە",
      privacy: "ئێمە پەیوەندیدارین بە پاراستنی زانیاریەکانت",
      ourTeam: "تیمی پشتیوانی ئامادەی یارمەتیدانە",
      headOffice: "سەرۆفیسی سەرەکی",
      welcomeHeadOffice: "بەخێربێیت بۆ فڕۆکەخانەی سەرەکی",
      workingDays: "دووشەممە تا هەینی، ٨ی بەیانی تا ٥ی ئێوارە",
      contactUs: "پەیوەندی پێوە بکە",
      contactForm: "فۆڕمی پەیوەندی",
      weWantToHearFromYou: "دەچێت پەیوەندی پێوە بکەیت! فۆڕمەکە تۆمار بکە",
      weLoveToHearFromYou: "خۆشحاڵ دەبین پەیامتان وەرگرین",
      haveQuestions: "هەندێک پرسیار یان کێشەیەکت هەیە؟ تیمی یارمەتیدان ئامادەن!",
    },
    complexes: {
      riyan: "کۆمەڵگای ڕەیە",
      rahat: "کۆمەڵگای ڕاحەت",
      zahia: "کۆمەڵگای زاهیا",
      yasmine: "کۆمەڵگای یاسمن",
      price25: "٢٥ دینار",
      price40: "٤٠ دینار",
      previous: "پێشوو",
      next: "دواتر",
    ...
    homeFive: {
      title: "کۆمەڵگای تۆمارکراوەکان دەربارەی شوێنت بزانە",
      showAll: "هەموو نیشان بدە",
      desc: "بگەڕێ بە کۆمەڵگای باشترین تۆمارکراوەکان. ووردەکاریەکان ببینە بۆ یەکێک یەکێک",
      details: "زیاتر بخوێنەوە",
      perMonth: "خێزان / تاکەکەس",
    },
    partnersSection: {
      title: "هاوپەیمانی سەرکەوتنەکانمان",
      showAll: "هەموو نیشان بدە",
      description: "کۆمەڵگاکەت بە هاوپەیمانی باشترین کۆمپانیاکان تێدا بەڕێوە دەبرێت بۆ پشتگیری چاکسازی و خزمەتگوزاریەکانی خانەنوو",
      lastUpdate: "نوێکردنەوەی کۆتا: ٢٠٢٠/١٢/٠٤ - ٤:١٣ بە کاتی عەرەبیی سعودی",
      locationText: "شوێن:",
      units: "یەکەی بەردەست",
      offer: "ئۆفەرە بەردەستەکان",
      phoneText: "ژمارەی تەلەفون",
      emailText: "ئیمەیڵ",
      categoryText: "پۆل",
      rating: "هەڵسەنگاندن",
      location: "بەغداد - ناوچەی یارمووک",
      count: "١٢ یەکە",
      discount: "١٠٪ داشکاندن بۆ کرێی ساڵانە",
      phone: "+٩٦٤ ٠٧٧ ١٢٣ ٧٦٥٤",
      email: "9Bb0M@example.com",
      category: "کارەبایی",
    },
    loginPage: {
    ...
    resetPage: {
      ...
      resetPassword: "وشەی نهێنی نوێ بکە",
    },
    compounds: {
      title: "کۆمەڵگای نیشتەجێبوون",
      description: "باشترین کۆمەڵگاکانی تۆمارکراوی Mojamaak بگەڕێ. زانیاری وورد ببینە لە شوێن، یەکەی بەردەست، و فەرمی نەخۆشیەکان.",
      viewDetails: "ووردەکاری ببینە",
    },
    footer: {
      overview: "پێشبینین",
      aboutPortal: "دەربارەی (ناوی گەڕۆک)",
      privacyTerms: "مەرجەکان و شەرەوطەکانی بەکارهێنان",
      howToUse: "چۆنیەتی بەکارهێنانی (ناوی گەڕۆک)",
      newsEvents: "هەواڵ و ڕووداوەکان",
      slaStats: "ئامارەکانی SLA",
      importantLinks: "بەستەرە گرنگەکان",
      nationalService: "گەڕۆکی خزمەتی نیشتمانی",
      openData: "داتا کراوەی حکومی",
      aiStrategy: "ستراتێژی داتا و AI ی نیشتمانی",
      openDataPortal: "گەڕۆکی داتا کراوە",
      eParticipation: "گەڕۆکی بەشداریی ئەلیکترۆنی",
      contactSupport: "پەیوەندی و پشتیوانی",
      customerCenter: "ناوەندی کڕیار",
      contactUs: "پەیوەندی پێوە بکە",
      shareWithUs: "بەشداری بکە لەگەڵمان",
      submitComplaint: "سکاڵا بنێرە",
      reportCorruption: "ڕاپۆرتی گەندەلی بدە",
      followUs: "پەیوەندیمان پێوە بکە",
      accessibilityTools: "ئامرازەکانی دەستگەیشتن",
      mobileApp: "ئەپڵیکەیشنی مۆبایل",
      rss: "RSS",
      siteSettings: "ڕێکخستنەکانی ماڵپەڕ",
      copyright: "هەموو مافەکان پارێزراوە بۆ دەسەڵاتداری حکومەتی دیجیتاڵی © {year}",
      developedBy: "پەرەسەند و چاودێری کراوە لەلایەن (ناوی دامەزراندەر)",
      lastUpdate: "نوێترین گۆڕانکاری: ٠٤/١٢/٢٠٢٠",
      downloadApp: "دابەزاندنی ئەپەکە",
      quickLinks: "بەستەرە خێراکان",
    },
    aboutPage: {
      know: "فێربە دەربارەی کۆمەڵگاکەت",
      knowDesc: "سیستەمی تەواوی بەڕێوەبردنی کۆمەڵگا. بەشەکانی بەڕێوەبردن، تۆمارکردنی هاوڵاتی، چاودێری چاکسازی و پارەدان.",
    },
  }
};
